  ...
  return (
    <html>
      <head>
        ...
        {!props.production && <script src="/build/map.bundle.js" />}
      ...
      <body>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyClL8CXbqII1QIVaNThKW-E9crgEw7zSYk&amp;libraries=drawing&amp;callback=initMap" />
      </body>
    </html>
  )
}
